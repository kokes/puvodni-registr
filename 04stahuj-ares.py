...
sml = pd.read_csv('vstupy/smlouvy.csv', dtype=str)

ica = sml.PARTNER_ICO.dropna().unique().tolist() + sml.ico.dropna().unique().tolist()
ica = [j.rjust(8, '0') for j in ica]
